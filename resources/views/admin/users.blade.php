    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
        ...
        <div class="flex items-center gap-2">
            <div class="relative">
                ...
                <input type="text" placeholder="Cari user..." class="pl-9 pr-4 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-accent-500 focus:border-accent-500">
            </div>
        </div>
    </div>
